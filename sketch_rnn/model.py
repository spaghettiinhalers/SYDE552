...
class Model(object):
  ...
  def __init__(self, hps, p_smallest=0.0, p_block=0.0, p_reflect=0.0, p_filter=0.0, gpu_mode=True, reuse=False): # !!
    ...
    with tf.variable_scope('vector_rnn', reuse=reuse):
      if not gpu_mode:
        with tf.device('/cpu:0'):
          ...
          self.build_model(hps, p_smallest, p_block, p_reflect, p_filter) # !!
      else:
  ...
  def build_model(self, hps, p_smallest, p_block, p_reflect, p_filter): # !!
