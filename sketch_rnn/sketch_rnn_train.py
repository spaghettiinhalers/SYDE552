...
def trainer(model_params, p_random, p_block, p_reflect, p_filter): # !!
  """Train a sketch-rnn model."""
  ...
  reset_graph()
  model = sketch_rnn_model.Model(model_params, p_random, p_block, p_reflect, p_filter) # !!
  eval_model = sketch_rnn_model.Model(eval_model_params, p_random, p_block, p_reflect, p_filter, reuse=True) # !!
...
def main(unused_argv):
  ...
  trainer(model_params, p_random, p_block, p_reflect, p_filter) # !!
  # at some point p will have to be loaded into main function, not really sure how to do this
