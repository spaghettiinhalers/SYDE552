...
def trainer(model_params, p_random): # !!
  """Train a sketch-rnn model."""
  ...
  reset_graph()
  model = sketch_rnn_model.Model(model_params, p_random) # !!
  eval_model = sketch_rnn_model.Model(eval_model_params, p_random, reuse=True) # !!
